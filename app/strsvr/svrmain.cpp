...
{
    const char *types[]={
        "None","Serial","File","TCP Server","TCP Client","UDP","Ntrip Sever",
        "Ntrip Client","FTP","HTTP","Ntrip Cast S","Ntrip Cast C"
    };
...
void __fastcall TMainForm::LoadOpt(void)
{
    ...
    for (int i=0;i<MAXSTR;i++) for (int j=0;j<2;j++) {
