...
{
    rtk_trace(3,"MenuOpenMapImageClick\n");
...
{
    rtk_trace(3,"MenuOpenShapeClick\n");
...
{
    rtk_trace(3,"MenuOpenSkyImageClick\n");
...
{
    rtk_trace(3,"MenuShowPointClick\n");
...
{
    rtk_trace(3,"BtnShowSkyplotClick\n");
